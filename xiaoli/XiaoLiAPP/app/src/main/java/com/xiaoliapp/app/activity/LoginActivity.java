		...
		public void handleMessage(Message msg) {
			if (msg != null) {
				...
				switch (flag) {
					...
					case 1:
						//登录成功,跳转到下一个Activity
						Intent intent = new Intent(LoginActivity.this, RelationActivity.class);
						ResponseMessage responseMessage = (ResponseMessage) msg.obj;
						intent.putExtra("uid", responseMessage.getUid());
						startActivity(intent);
						MyLog.d("Login", "status:" + msg.what + "  data:" + responseMessage);
						break;
					default:
						break;
				}
