 ...
 */
public class RelationContentListAdapter extends BaseExpandableListAdapter {

	private Context context;
	private List<String> parents;
	private List<List<Friend>> children;

	public RelationContentListAdapter(Context context, List<String> parent, List<List<Friend>> child) {
